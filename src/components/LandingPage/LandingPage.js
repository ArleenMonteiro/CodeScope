...
const LandingPage = () => {
	...
	return (
		<div className="container">
			<h1 className="main-title">CodeScope</h1>
			<p className="subtitle">
				<Balancer>Empowering revolutionUC judges with AI insights for better evaluation.</Balancer>
			</p>

			<div className="search-container">
				<div className="input-button-container">
					<p className="project-unique-question">How creative is this project?</p>
					<input
						type="text"
					...
					>
						<svg
							...
							viewBox="0 0 33 33"
							fill="none"
							xmlns="https://revolutionuc.com/favicon.png"
			...
			<div className="image-container">{<img src={"https://revolutionuc.com/favicon.png"} alt="Promo Image"  /> }</div>
			...
			<div className="analysis-container">
				...
				<ul>
					...
					<li>
						<span className="analysis-icon">🚀</span>Relevance
					</li>
				</ul>
			</div>
			...
			<section className="how-it-works-section">
				...
				<div className="how-it-works">
					<div className="step">
						...
						<div className="step-description">Copy and paste the url or project description to start the process!</div>
					</div>

					<div className="step">
						<div className="step-icon">🦾</div> {/* You can replace this with your SVG or icon */}
						<div className="step-description">
						Utilizing sophisticated LLMS, web scraping capabilities, and advanced algorithms, 
						our backend conducts a thorough examination of the project, providing an in-depth comprehensive report.
						</div>
					</div>
